...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/cert-secret-syncer/main/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/cert-secret-syncer:1.3.1'
